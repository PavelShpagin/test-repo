/*
  Pac‑Man JS – Complete Working Game
  Features:
  - Fully functional Pac-Man game
...
(function() {
  ...
  // Simple but complete maze layout
  const MAZE = [
    '###################',
    '#........#........#',
    '#.##.###.#.###.##.#',
  ...
  class Ghost {
    ...
    reset() {
      ...
      this.mode = 'chase';
      this.spawnTimer = 2000; // 2 second delay
    }
    ...
    draw() {
      if (this.spawnTimer > 0) return; // Don't draw if not spawned yet
